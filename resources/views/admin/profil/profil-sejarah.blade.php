...
@section('content')<div class="container mt-3">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            @if(isset($sejarah) && $sejarah && !empty($sejarah->konten))
                            {{ $sejarah->konten }}
                            @else
        ...
        {{-- Modal-Sejarah --}}
        <div class="modal fade" id="modal-sejarah">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <textarea class="form-control @error('konten') is-invalid @enderror"
                                        id="kontenSejarah" name="konten" rows="5" required>{{ old('konten', isset($sejarah) ? $sejarah->konten : '') }}
                                    </textarea>
                                    @error('konten')
